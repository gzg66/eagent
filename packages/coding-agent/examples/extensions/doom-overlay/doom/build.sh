#!/usr/bin/env bash
# Build DOOM for agent-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_agent.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
