 ...
 * working indicator shown while agent is streaming a response.
 *
 * Usage:
 *   eagent --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore agent's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@enterprise-agent/coding-agent";
