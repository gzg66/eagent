 ...
 * - Routing tool calls to remote systems (e.g., agent-ssh-remote)
 ...
 *
 * Usage:
 *   eagent -e ./tool-override.ts
 */

import type { TextContent } from "@enterprise-agent/ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@enterprise-agent/coding-agent";
