...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@enterprise-agent/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@enterprise-agent/tui";
