...
import { complete, type Message } from "@enterprise-agent/ai/compat";
import type { ExtensionAPI, SessionEntry } from "@enterprise-agent/coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@enterprise-agent/coding-agent";
