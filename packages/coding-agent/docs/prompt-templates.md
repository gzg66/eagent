> agent can create prompt templates. Ask it to build one for your workflow.
...
Enterprise Agent loads prompt templates from:

- Global: `~/.eagent/prompts/*.md`
- Project: `.eagent/prompts/*.md` (only after the project is trusted)
