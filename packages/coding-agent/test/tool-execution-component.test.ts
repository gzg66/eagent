...
import { Text, type TUI } from "@enterprise-agent/tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".eagent", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .eagent/AGENTS.md",
		...
		{
			title: "Enterprise Agent documentation",
			path: getReadmePath(),
	...
	for (const scenario of [
		...
		{ title: "Enterprise Agent documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
