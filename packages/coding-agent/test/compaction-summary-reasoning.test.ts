...
import type { AssistantMessage, Model } from "@enterprise-agent/ai";
...
vi.mock("@enterprise-agent/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@enterprise-agent/ai/compat")>();
	return {
		...actual,
