 ...
 * Encodes cwd into a safe directory name under .eagent/sessions/.
 */
...
export class SessionManager {
	...
	setSessionFile(sessionFile: string): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a agent session, fail without modifying it.
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (.eagent/sessions/<encoded-cwd>/).
	 */
