 ...
 * Provider authentication orchestration belongs to ModelRuntime and the AI package.
 */

import type { Credential, CredentialInfo, CredentialStore } from "@enterprise-agent/ai";
