import { Container, getKeybindings, Spacer, Text } from "@enterprise-agent/tui";
...
const SETUP_LOGO_LINES = ["ENTERPRISE", "AGENT"];

/** First-time setup dialog for local appearance. */
export class FirstTimeSetupComponent extends Container {
	...
	private update(): void {
		...
		this.addChild(new Spacer(1));
		this.addChild(
			new Text(theme.fg("accent", theme.bold(`Welcome to ${APP_NAME}, the enterprise coding agent.`)), 1, 0),
		);
		this.addChild(new Spacer(1));
